...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const closeWithEsc = ({ key }: KeyboardEvent) => {
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <Link
                  href="#"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-blue-400 d ${pathname.includes("calendar") &&
                    "bg-graydark "
                    }`}
                >
                  <svg
